...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://localhost/OApa!/View/styles/login.css" />
  ...
  ?>
    <form action="login_check.php" method="post">
      ...
      <div class="row d-flex justify-content-around align-items-center">
        <div class="col-md-6">
          <img id="banner" src="http://localhost/OApa!/View/banners/login.png" alt="" />
        </div>
        <div class="col-md-6" id="login-section">
          <div id="card-bg" class="card text-center">
            <div class="card-header">
              <label for="">Login As :</label><br />           
              <img src="http://localhost/OApa!/View/icons/user.png" alt="" class="user" /><br />
            ...
            <div class="card-footer">
              ...
              <h5>
                ...
                <a id="link" href="http://localhost/OApa!/Model/forms/registration.php">Register Now!</a>
              </h5>
            </div>
          </div>
        </div>
        <a id="btn" href="http://localhost/OApa!/Model/forms/admin_login.php">Login as Admin</a>
      </div>
    </form>
    <script src="http://localhost/OApa!/Model/jquery/jquery.js"></script>
    <script src="http://localhost/OApa!/View/bootstrap/js/bootstrap.min.js"></script>
    <script src="http://localhost/OApa!/Model/js/login.js"></script>
  </body>
</html>
