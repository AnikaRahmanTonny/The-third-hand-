...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://localhost/OApa!/View/styles/slip.css">
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-md-6 d-flex justify-content-around">
        <div id="card-bg" class="card text-center">
          ...
          <div class="card-body">
            <div class="img">
              <img src="http://localhost/OApa!/View/icons/userdp.png" alt="" class="user" /><br />
          ...
          <div class="card-footer">
            <a id ="btn" href="http://localhost/OApa!/Model/forms/about.php">Done</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript" src="http://localhost/OApa!/Model/js/timer.js"></script>
