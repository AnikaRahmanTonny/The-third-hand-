...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://localhost/OApa!/View/styles/about.css" />
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                        ...
                        <li class="nav-item">
                <a class="nav-link btn btn-danger" id="logout-btn" href="http://localhost/OApa!/Model/forms/logout.php"
                  ><b>Logout</b></a
                ></li>
            </ul>
          </div>
    ...
    <row id="info" class="d-flex bd-highlight mb-3">
      <div id="about" class="col-md-4 mr-auto p-2 bd-highlight">
        ...
        <p>
          ...
          Currenty this service is ongoing inside Banani,Dhaka.
        </p>
      </div>
      ...
      <div id="infos" class="col-md-4 p-2 bd-highlight">
        <ul>
          ...
          <li>
            ...
            <span id="location"
              >BRACU , 66, Mohakhali, Dhaka 1219, Bangladesh</span
            >
          </li>
          <li>
