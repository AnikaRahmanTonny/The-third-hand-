...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/OApa!/View/styles/location.css" />
    ...
    <form action="" method="post">
        <div class="">
            <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                <a class="navbar-brand" href="#"><img src="http://localhost/OApa!/View/icons/navlogo.png" alt="" /></a>
        ...
        <div class="row d-flex justify-content-around align-items-center">
            <div class="col-md-6 ">
                <img id="banner" src="http://localhost/OApa!/View/banners/map.png" alt="">
            </div>
            <div class="col-md-6" id="login-section">
                <div id="card-bg" class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <div id="map">
                            <script src="..http://localhost/OApa!/Model/js/location.js"></script>
                            <script
                    ...
                    <div class="card-footer">
                        <a id = "btn" href="http://localhost/OApa!/Model/forms/selection.php">Done</a>
                    </div>
                </div>
            </div>
